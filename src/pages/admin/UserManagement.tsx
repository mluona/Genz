...
import { Shield, Ban, Trash2, Search, MoreVertical, Filter, Calendar, Mail, User as UserIcon, CheckCircle, XCircle } from 'lucide-react';
      ...
      {selectedUser && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl p-8 space-y-8">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-black uppercase tracking-tight">User Profile</h2>
